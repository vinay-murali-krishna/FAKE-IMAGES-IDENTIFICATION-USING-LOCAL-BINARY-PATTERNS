...
main = tkinter.Tk()
main.title("Detect/Remove Duplicate Images from a Dataset for Deep Learning") #designing main screen
...
def classify():
    ...
    msg = ""
    if predict == 0:
        msg = "Image Contains Duplicate face"
    if predict == 1:
...
font = ('times', 16, 'bold')
title = Label(main, text='Detect/Remove Duplicate Images from a Dataset for Deep Learning', justify=LEFT)
